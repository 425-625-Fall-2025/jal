...
AIC-based stepwise selection chose a model with 3 predictors: Sale Price, eyb, and Total Rooms, yielding an AIC = -1955.5 and R^2 of about 0.90. Sale Price had the lowest p value, and eyb and Total Rooms also had positive coefficients and significant p values. 

BIC-based stepwise selection chose a model with 4 predictors: Land Acres, Effective Area, Total Rooms, and Sale Year. All coefficients except Number of Bedrooms 
