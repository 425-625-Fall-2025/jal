...
BIC-based stepwise selection chose a model with 3 predictors: Sale Price, eyb, and Total Rooms, yielding an  R^2 of about 0.90. Sale Price had the lowest p value, and eyb and Total Rooms also had positive coefficients and significant p values. 

AIC-based stepwise selection chose a model with 6 predictors: Effective Area, Total Rooms, Number of Bedrooms, Sale Price, ayb, and eyb. All coefficients except Number of Bedrooms are positive, and the R^2 is about 
