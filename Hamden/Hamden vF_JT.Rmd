...
cor1 <- cor(train_data[, c('Sale_2024', 'Land.Acres', 'Living.Area', 'Effective.Area', 'Total.Rooms', 'Number.of.Bedroom', 'Number.of.Baths', 'Number.of.Half.Baths', 'ayb', 'eyb', 'appraised_2009')], use = "pairwise.complete.obs")
...
# stepwise regression example code
  model_cv_stepwise <- train(
      Fertility ~ .,
      data = swiss,
      method = "lmStepAIC",
...
# results example code
    print(model_cv_stepwise)
    model_cv_stepwise$results
