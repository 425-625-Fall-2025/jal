...
```{r}
data1 <- read.csv("/Users/jaketodd/Desktop/CaseStudy3/Connecticut_CAMA_and_Parcel_Layer_3895368049124948111.csv")
sale_data <- read_excel("/Users/jaketodd/Desktop/CaseStudy3/sales_data.xlsx")
```
```{r}
...
for(i in 1:nrow(data_hamden)){
  temp_html <- read_html(paste0('/Users/jaketodd/Downloads/Hamden_Sept2025/',data_hamden$PID[1],'.html'))
  tables <- temp_html %>% 
    html_elements("table") %>%   
