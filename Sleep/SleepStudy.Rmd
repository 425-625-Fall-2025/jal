...
Based on the analysis of the pilot study data, the SomnoPose data shows a reasonable level of agreement with the Embletta data, particularly in terms of overall trends and changes in sleeping position. However, they were consistently off by around 50 degrees. Although this was adjusted for in the adjusted angle graphs, the peak angles recorded by each device still did not align perfectly. These discrepancies are likely due to differences in device placement, fit, and size. 
...
A larger, standardized study would allow for calibration between devices (such as aligning the definition of 0 degrees), reduce variability introduced by uncontrolled factors such as environment or sleep quality, and ensure consistent and reliable start/stop times (which often had to be inferred for the Embletta).
